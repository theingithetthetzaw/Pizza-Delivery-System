...
namespace Pizza_Delivery_System
{
    public partial class CustomerChangePassword : System.Web.UI.Page
    {
        ...
        protected void btnChangePass_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select * from CustomerMaster where EmailId=@id and Password=@pass", con);
            ...
            {
                cmd = new SqlCommand("update CustomerMaster set Password=@pass where EmailId=@id", con);
